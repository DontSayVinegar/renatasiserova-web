...
export const en: Dictionary = {
  ...
  nav: {
    ...
    close: 'Close',
    switchLang: 'Česky',
    switchLangLabel: 'Přepnout do češtiny',
  },
  hero: {
  ...
  trust: {
    years: 'years in real estate',
    marketing: 'years in marketing',
    club: 'RE/MAX 100% Club',
    reviews: 'reviews rated 5/5',
    office: 'RE/MAX Anděl, Prague 5',
  },
  home: {
    featuredTitle: 'Current listings',
    featuredAll: 'All properties',
    ...
    ctaText:
      'Write or call me. The first consultation and a market price estimate are free and non-binding.',
  ...
  listings: {
    ...
    detail: {
      ...
      interestedText: 'Send me a message to arrange a viewing, or call',
      cta: "I'm interested",
      source: 'Listing on remax-czech.cz',
  ...
  sold: {
    title: 'Sold & rented',
    intro:
      'A selection of properties I have recently sold or rented out. Behind each one is a satisfied client.',
  },
  reviews: {
    title: 'Reviews',
  ...
  process: {
    ...
    steps: [
      {
        ...
        text: 'We meet at your place or in my office. I walk through the property and the market with you, and we set a realistic selling strategy and price. Free and non-binding.',
      },
      {
        title: 'Preparing the property',
        text: 'I get the property ready to impress: cleaning, small fixes, home staging. First impressions decide the price more than most sellers think.',
      },
      {
        title: 'Professional presentation',
        text: 'Professional photography, floor plans, video and copy. Twenty years in marketing means your property will not be just another listing among thousands.',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'With the right price and quality presentation, usually 4–8 weeks to reservation. I will give you a more precise estimate for your property and location at the consultation.',
      },
      {
  ...
  contact: {
    ...
    form: {
      ...
      message: 'Message',
      messagePlaceholder: 'Hello, I would like to sell a 2-bedroom apartment in Prague…',
      submit: 'Send message',
      sending: 'Sending…',
      success: 'Thank you! Your message is on its way. I will get back to you as soon as possible.',
      error: 'The message could not be sent. Please try again, or simply call me.',
      gdpr: 'By submitting the form you agree to the processing of your data for the purpose of handling your enquiry.',
  ...
  footer: {
    ...
    coi: 'Consumer disputes may be resolved out of court via the Czech Trade Inspection Authority (coi.cz).',
